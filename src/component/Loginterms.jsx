      ...
      >
        ...
        >
          ...
          >
            ...
            <Text color={"red"}>
              [중요]악용 및 투표 조작을 막기 위해 중복으로 아이디 2개 이상
              사용할 경우, 모든 아이디가 차단될 수 있습니다.
            </Text>
            <br />
            <Text>제1조 (목적)</Text>
            <Text>
              본 약관은 O_O(이하 "회사"라 합니다)가 제공하는 O_O 및 O_O 관련
              제반 서비스(이하 "서비스"라 합니다)의 이용과 관련하여 회사의
              회원과의 관리, 의무 및 책임사항, 기타 필요한 사항을 규정함을
              목적으로 합니다.
            </Text>
            ...
            <OrderedList>
              ...
              <ListItem>
                회사는 제1항과 같이 회원으로 기입할 것을 신청한 자가 다음 각
              ...
              <OrderedList>
                ...
                <ListItem>
                  제6조 제2항에 해당하는 회원 자격 제한 및 정지, 상실을 한
                  경험이 있었던 경우
                </ListItem>
                <ListItem>
                  기타 회원으로 등록하는 것이 회사의 서비스 운영 및 기술상
                  현저히 지장이 있다고 판단되는 경우
                </ListItem>
              </OrderedList>
              <ListItem>
            ...
            <OrderedList>
              <ListItem>
                ...
                중단할 수 있고, 새로운 서비스로의 교체, 기타 회사가 적절하다고
              ...
              <ListItem>
                ...
                인한 서비스의 중단(시스템 관리자의 고의, 과실이 없는 디스크
            ...
            <OrderedList>
              <ListItem>
                회원은 회사에 언제든지 자신의 회원 등록 말소(회원 탈퇴)를 요청할
                수 있으며 회사는 위 요청을 받은 즉시 해당 회원의 회원 등록
                말소를 위한 절차를 밟습니다.
              </ListItem>
              <ListItem>
                탈퇴할 경우, 커뮤니티 서비스, 기타 공용 게시판 등에 등록된
                게시물은 자동 삭제되지 않습니다.
              </ListItem>
              <ListItem>
                ③ 회원이 다음 각 호의 사유에 해당하는 경우, 회사는 회원의
            ...
            <OrderedList>
              <ListItem>
                ...
                않으며 본 약관이 정하는 바에 따라 지속적이고, 안정적으로
                서비스를 제공하기 위해서 노력합니다.
              </ListItem>
              <ListItem>
                회사는 회원이 안전하고 편리하게 서비스를 이용할 수 있도록
                시스템을 구축합니다.
              </ListItem>
              <ListItem>
                회사는 회원이 서비스를 이용함에 있어 회원에게 손해를 배상할
                책임이 없습니다.
              </ListItem>
            </OrderedList>
            ...
            <OrderedList>
              <ListItem>
                회사가 관계법령, "개인정보보호정책"에 의해서 그 책임을 지는
                경우를 제외하고, 자신의 ID와 비밀번호에 관한 관리책임은 각
                회원에게 있습니다.
              </ListItem>
              <ListItem>
            ...
            <OrderedList>
              ...
              <OrderedList>
                ...
                <ListItem>
                  회사 및 제3자의 지적재산권을 침해하거나 회사의 권리와 업무
                  또는 제3자의 권리와 활동를 방해하는 행위
                </ListItem>
                ...
                <ListItem>
                  회사가 제공하는 관련 서비스에 게시된 공지사항 규정을 위반하는
                  행위
                </ListItem>
                <ListItem>서버나 회선에 무리를 줄 수 있는 행위</ListItem>
                <ListItem>
                  사람의 직접적인 행동이 아닌 자동화된 프로그램이나 봇을 통해
                  로그인 및 로그인된 사용자가 하는 기능들을 이용하는 행위 또는
                  사이트 내용을 추출해서 광고를 제거해서 다시 제공하는 행위
                </ListItem>
              </OrderedList>
              <ListItem>
                제1항에 해당하는 행위를 한 회원이 있을 경우 회사는 본 약관 제6조
                제2, 3항에서 정한 바에 따라 회원의 회원자격을 적절한 방법으로
                제한 및 정지, 상실시킬 수 있습니다.
              </ListItem>
              <ListItem>
                회원은 그 귀책사유로 인하여 회사나 다른 회원이 입은 손해를
                배상할 책임이 있습니다.
              </ListItem>
            </OrderedList>
            ...
            <OrderedList>
              <ListItem>
                ...
                해당 공개게시물에 회원에게 사전 통지 없이 해당 공개게시물을 삭제
                또는 변경할 수 있고, 해당 회원의 회원 자격을 제한, 정지 또는
                상실시킬 수 있습니다.{" "}
              </ListItem>
              <OrderedList>
                <ListItem>
                ...
                <ListItem>
                  음란물, 욕설 등 공서양속에 위반되는 내용의 정보, 문장, 도형
                  등을 유포하는 내용
                </ListItem>
              ...
              <ListItem>
                ...
                또는 제3자가 회원 또는 회사를 대상으로 하여 민형사상의 법적
                조치(예:고소, 가처분신청, 손해배상청구소송)를 취하는 동시에 법적
                조치와 관련된 게시물의 삭제를 요청해오는 경우, 회사는 동 법적
                조치의 결과(예: 검찰의 기소, 법원의 가처분결정, 손해배상판결)가
                있을 때까지 관련 게시물에 대한 접근을 잠정적으로 제한할 수
                있습니다.
              </ListItem>
              <ListItem>
                회사는 서비스 악용 방지를 위해 일부 게시물에 대해 수정 및 삭제
                가능 여부를 제한할 수 있습니다.{" "}
              </ListItem>
            </OrderedList>
            ...
            <OrderedList>
              ...
              <OrderedList>
                ...
                <ListItem>
                  ...
                  제공, 전시 혹은 홍보하게 하는 것. 단, 이 경우 회사는 별도의
                  동의 없이 회원의 이용자ID 외에 회원의 개인정보를 제공하지
                  않습니다.
                </ListItem>
                <ListItem>
                  회사는 전항 이외의 방법으로 회원의 게시물을 이용하고자 하는
                  경우, 전화, 팩스, 전자우편 등의 방법을 통해 사전에 회원의
                  동의를 얻어야 합니다.
                </ListItem>
                <ListItem>
                  회사는 법적인 제한이 있는 글이 아니라면 사용자의 게시물을
                  삭제할 의무가 없습니다.
                </ListItem>
              </OrderedList>
            </OrderedList>
            ...
            <OrderedList>
              <ListItem>
                ...
                광고게재를 통한 수익으로부터 나옵니다. 회원은 회원이 등록한
            ...
            <OrderedList>
              ...
              <ListItem>
                ...
                약관이 공지된 후 14일 이내에 거부의사를 표명할 수 있습니다.
                회원이 거부하는 경우 회사는 당해 회원과의 계약을 해지할 수
                있습니다. 만약 회원이 변경된 약관이 공지된 후 14일 이내에
                거부의사를 표시하지 않는 경우에는 동의하는 것으로 간주합니다.
              </ListItem>
            </OrderedList>
