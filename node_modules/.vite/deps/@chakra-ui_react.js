...
var BaseAnimation = class {
  ...
  onKeyframesResolved(keyframes3, finalKeyframe) {
    ...
    this._resolved = {
      ...
      finalKeyframe,
      ...this.initPlayback(keyframes3, finalKeyframe)
    };
    this.onPostResolved();
  }
  onPostResolved() {
...
var MainThreadAnimation = class extends BaseAnimation {
  ...
  tick(timestamp, sample = false) {
    const { finalKeyframe, generator, mirroredGenerator, mapPercentToKeyframes, keyframes: keyframes3, calculatedDuration, totalDuration, resolvedDuration } = this.resolved;
